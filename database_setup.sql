...
VALUES 
  ('John', 'Doe', 'john.doe@example.com', 'password', 170, 70, 25, 'Male', 2, 1),
  ('Jane', 'Doe', 'jane.doe@example.com', 'password', 160, 60, 30, 'Female', 3, 1),
  ('Bob', 'Smith', 'bob.smith@example.com', 'password', 180, 80, 40, 'Male', 1, 2);
